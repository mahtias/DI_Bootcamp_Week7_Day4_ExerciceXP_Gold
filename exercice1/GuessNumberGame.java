...
/**
 * @author N'ZO LAGOU
 * Exercice 1 : Devinez Un Nombre
Instructions
C'est un jeu simple : générez un nombre entier aléatoire de 1 à 1000

Demandez à l'utilisateur de deviner quel nombre a été généré :

L'utilisateur tape un nombre.
Si c'est celui généré, écrivez "Ouais, vous l'avez trouvé!"
 et terminer le jeu.
S'il est inférieur à celui généré, écrivez "Mauvais, c'est 
trop petit". et demander à nouveau l'entrée.
S'il est supérieur à celui généré, écrivez "Mauvais, c'est 
trop gros". et demander à nouveau l'entrée.
Jouez le jeu tout seul : vous contre votre propre logiciel,
